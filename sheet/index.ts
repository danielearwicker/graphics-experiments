...
for (let x = 0; x < cells; x++) {
    for (let y = 0; y < cells; y++) {
        positions.push(
            (x * cellEdge) - offset, (y * cellEdge) - offset,
            (x * cellEdge) - offset, ((y + step) * cellEdge) - offset,
            ((x + step) * cellEdge) - offset, ((y + step) * cellEdge) - offset,
            (x * cellEdge) - offset, (y * cellEdge) - offset,
            ((x + step) * cellEdge) - offset, (y * cellEdge) - offset,
            ((x + step) * cellEdge) - offset, ((y + step) * cellEdge) - offset
        );
    }
}
